...
/// 表示 Markdown 的强调节点。
/// </summary>
public sealed class Emphasis : InlineNode, INodeContainer<InlineNode>, IEquatable<Emphasis>
{
	/// <summary>
	/// 子节点列表。
	/// </summary>
	...
	/// <summary>
	/// 使用指定的文本范围初始化 <see cref="Emphasis"/> 类的新实例。
	/// </summary>
	/// <param name="span">文本的范围。</param>
	public Emphasis(TextSpan span = default)
		: base(MarkdownKind.Emphasis)
	{
	...
	public bool Equals(Emphasis? other)
	{
		if (other is null)
		{
			return false;
	...
	#endregion // IEquatable<Emphasis> 成员
