...
/// 表示 Markdown 的文本。
/// </summary>
public sealed class Literal : InlineNode, IEquatable<Literal>
{
	/// <summary>
	/// 文本的内容。
	/// </summary>
	...
	/// <summary>
	/// 使用指定的文本内容和文本范围初始化 <see cref="Literal"/> 类的新实例。
	/// </summary>
	/// <param name="content">文本的内容。</param>
	/// <param name="span">文本的范围。</param>
	public Literal(string content, TextSpan span = default) : base(MarkdownKind.Literal)
	{
	...
	{
		return new Literal(content, Span)
		{
			Locator = Locator,
		};
	}
	...
	#endregion // IEquatable<Literal> 成员
