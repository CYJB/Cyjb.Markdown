...
[LexerRegex("ExtAttrValue", @"{ExtAttrChar}+|'[^'\r\n]*'|\""[^""\r\n]*\""")]
[LexerRegex("ExtAttrItem", @"#{ExtAttrChar}|\.{ExtAttrChar}|{AttrName}|{AttrName}={ExtAttrValue}")]
[LexerRegex("ExtAttr", @"\{{WS_A}\}|\{{WS_A}{ExtAttrItem}({WS_1}{ExtAttrItem})*{WS_A}\}")]
